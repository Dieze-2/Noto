...
import {
  ...
  Dumbbell, Trash2, Sparkles, X } from
"lucide-react";
...
import {
  ...
  WorkoutExerciseRow, WorkoutExerciseSetRow } from
"@/db/workouts";
...
}: {setRow: WorkoutExerciseSetRow;onDelete: (id: string) => void;onEdit: (s: WorkoutExerciseSetRow) => void;}) {
...
}: {ex: WorkoutExerciseRow;sets: WorkoutExerciseSetRow[];onDeleteMaster: (id: string) => void;onDeleteSet: (id: string) => void;onOpenAddSet: (ex: WorkoutExerciseRow) => void;onEditMaster: (ex: WorkoutExerciseRow) => void;onEditSet: (s: WorkoutExerciseSetRow) => void;}) {
  const x = useMotionValue(0);
