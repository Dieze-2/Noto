    ...
    <div className="min-h-screen flex flex-col max-w-xl mx-auto px-4 pt-12 pb-32">
      ...
      <section className="space-y-6 text-center">
        <div className="glass-card p-10 rounded-[3rem] grid grid-cols-1 gap-5 shadow-2xl border-t border-white/10">
          <label className="w-full bg-white/5 border border-white/5 py-6 rounded-2xl font-black text-[11px] uppercase tracking-widest text-white cursor-pointer hover:bg-white/10">
            Importer (.json)
