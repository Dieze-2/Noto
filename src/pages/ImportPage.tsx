  ...
  return (
    <div className="max-w-xl mx-auto px-4 pt-8 pb-32 space-y-8">
      <header className="text-center space-y-4">
        ...
        <h1 className="text-4xl font-black text-white italic uppercase tracking-tighter">Système</h1>
      </header>
      ...
      <section className="space-y-6 text-center">
        ...
        {status && <p className="font-black text-xs uppercase text-menthe">{status}</p>}
      </section>
    </div>
  );
}