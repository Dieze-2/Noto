...
import {
  ...
  Loader2, Send, X, User, Crown, AlertTriangle, Trash2, Moon } from
"lucide-react";
...
import {
  getCoachAthletes, inviteAthlete, removeAthlete, CoachAthlete } from
"@/db/coachAthletes";
import { getProfiles, displayName, Profile } from "@/db/profiles";
import {
  canInviteAthlete, PLAN_CONFIG, CoachPlan,
  getCoachSubscription } from
"@/db/coachSubscriptions";
